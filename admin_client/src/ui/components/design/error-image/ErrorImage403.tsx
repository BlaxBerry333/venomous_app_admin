...
import ErrorImageBackground from "./ErrorImageBackground";

const Error403Image: NamedExoticComponent<{
  PRIMARY_LIGHT: string;
  PRIMARY_LIGHTER: string;
  PRIMARY_MAIN: string;
  PRIMARY_DARK: string;
  PRIMARY_DARKER: string;
}> = memo(({ PRIMARY_LIGHT, PRIMARY_MAIN, PRIMARY_DARK, PRIMARY_DARKER }) => {
  return (
    <MuiBox
      component="svg"
      width="100%"
      ...
      sx={{ height: 200, maxWidth: 1, flexShrink: 0 }}
    >
      <ErrorImageBackground PRIMARY_MAIN={PRIMARY_MAIN} />
